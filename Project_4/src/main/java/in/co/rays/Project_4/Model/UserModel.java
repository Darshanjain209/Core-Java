...
public class UserModel {
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		...
		System.out.println("query chl gyii");
		UserBean bean = null;
		Connection conn = null;
		System.out.println("objects create ho gyee");

		try {
			conn = JDBCDataSource.getConnection();
			System.out.println("connections mil gye");
			PreparedStatement pstmt = conn.prepareStatement(sql.toString());
			pstmt.setString(1, login);
			pstmt.setString(2, password);
			ResultSet rs = pstmt.executeQuery();
			System.out.println("query execute ho gyii");
			while (rs.next()) {
				System.out.println();
				bean = new UserBean();
				System.out.println("bean ka object ban gya");
				bean.setId(rs.getLong(1));
				bean.setFirstName(rs.getString(2));
				bean.setLastName(rs.getString(3));
				bean.setLogin(rs.getString(4));
				...
				bean.setCreatedDateTime(rs.getTimestamp(17));
				bean.setModifiedDateTime(rs.getTimestamp(18));
				System.out.println("chize set ho gyii");
